...
exports.run = async (client, message, args) => {
  if (!message.author.id === '264563977005170688') return message.reply("You don't have the permission to use this command...:facepalm:");
    //message.delete();
    ...
    if (args[0] === '264563977005170688') return message.reply("You can't blacklist yourself... That would be horrible.");
