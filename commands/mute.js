...
exports.run = async (client, message, args) => {
  ...
  if(message.mentions.users.first().id === "264563977005170688") return message.reply('You can\'t mute him baka.')
  if(message.author.id === message.mentions.users.first()) return message.reply("You can't mute yourself, baka");
  if (!muteRole) {
    try {
