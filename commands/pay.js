...
exports.run = async (client, message, args) => {
  ...
  if (user === message.author) return message.channel.send("You can't pay yourself mora:facepalm:");
  ...
  Coins.findOne({
    ...
    if (!coins) {
        ...
        newCoins.save()
        return message.reply("You don't have enough mora!")
        ...
        Coins.findOne({
          ...
          .addField(`Payment`,`You have paid ${user.username} ${args[1]} mora!`)
...
exports.help = {
    name: 'pay',
    description: 'Pay someone with Mora.',
